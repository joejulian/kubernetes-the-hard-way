...
### AWS and GCE
Set the static controller addresses

```
INITIAL_CLUSTER=controller0=https://10.240.0.10:2380,controller1=https://10.240.0.11:2380,controller2=https://10.240.0.12:2380
```

###JPC
Set the dynamic controller addresses
