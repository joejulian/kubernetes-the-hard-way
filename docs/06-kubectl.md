...
```
wget https://storage.googleapis.com/kubernetes-release/release/v1.5.2/bin/darwin/amd64/kubectl
chmod +x kubectl
...
> TODO: instructions based on an haproxy

> For now, do this all from the bastion
