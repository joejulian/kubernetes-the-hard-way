...
* [Joyent Public Cloud](https://www.joyent.com/triton)
...
JPC
* The us-sw-1 region will be used
...
* [Joyent Public Cloud](https://www.joyent.com/triton), and the [Triton CLI](https://github.com/joyent/triton)

## Labs

While GCP, AWS, or JPC will be used for basic infrastructure needs, the things learned in this tutorial apply to every platform.
